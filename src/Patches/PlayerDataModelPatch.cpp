...
namespace ModifiersCoreQuest {
    ...
    std::optional<GlobalNamespace::PlayerData*> PlayerDataModelPatch::get_PlayerData() {
        return PlayerDataModelPatch::_playerDataModel.has_value() ? PlayerDataModelPatch::_playerDataModel.value()->playerData : std::optional<GlobalNamespace::PlayerData*>();
    }
